...
SECRET_KEY = 'django-insecure-gltwrukq&_2mby0ifx_8x8(5d493%&w%oz3ez)py6tx#nx@k=8'
...
TEMPLATES = [
    {
        ...
        # ఖచ్చితంగా ఈ కింది విధంగా మార్చండి:
        'DIRS': [BASE_DIR / 'core_marketplace' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
